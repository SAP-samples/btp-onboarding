...
## Skip Object Store If the Credentials Are Available

Going straight to your target data repository is the better choice when you already hold the credentials required by AI Core Document Grounding — for example, for a SharePoint site, an S3 bucket, or a Work Zone with Document Grounding enabled — and have completed an AI Core Document Grounding setup before. In that case, you can skip the **Data Repositories** phase and start directly with the **AI Core Document Grounding** phase.
