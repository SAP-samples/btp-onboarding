...
<p align="center">
  <img src="images/solution-diagram.png" width="80%">
</p>
...
<p align="center">
  <img src="images/ai-core-consumption-tracking.png" width="80%">
</p>
...
- **Connection to SAP Joule for Consultants** — configure a Destination Service instance, then enable Custom Knowledge Grounding in the SAP Joule for Consultants Console and connect it to the pipeline.
...
> **Note:** Depending on what is already in place — an existing AI Core Document Grounding pipeline, ready-to-use data repository credentials, or neither — you may be able to skip directly to a later phase. The next card, **Recommendations**, opens with a decision tree for choosing the right entry point and then covers data repository choice and subaccount layout.