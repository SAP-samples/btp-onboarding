...
> **Note:** The Bruno and AI Launchpad cards are two interchangeable paths to the same outcome. Bruno is a free, open-source API client; SAP AI Launchpad is an alternative UI-driven route that requires a paid subscription. Pick whichever fits your workflow.
...
If you take the AI Launchpad path, note that SAP AI Launchpad is also a paid subscription (`standard` plan): [SAP AI Launchpad — SAP Discovery Center](https://discovery-center.cloud.sap/serviceCatalog/sap-ai-launchpad).
