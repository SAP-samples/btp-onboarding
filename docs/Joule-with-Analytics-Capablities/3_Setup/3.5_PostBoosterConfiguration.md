...
<b>3.1	Create an OAuth Client for the Design Time in SAP SAC</b>
...
<h1 style ="font-size:4;"<b>4.	Sync Users from SAP SAC to SAP Build Work Zone using IPS</b></h1>

In the following steps, we are going to sync users from SAP SAC to SAP Build Work Zone. We will be working on SAP Cloud Identity Services, and you will need access as an Administrator. 
