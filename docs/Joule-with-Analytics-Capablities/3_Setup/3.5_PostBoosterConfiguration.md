...
Role definitions with these permissions then in SAP Analytics Cloud need to be made available in SAP Build Work Zone by synching them as CDM content. Team definitions are also synched. Follow the detailed steps below to complete these configurations. 
