<h1 style="fot-size:4;">1.	<b>Verification</b></h1>
...
For users to use analytical insights, the role their user account is assigned to in SAP Analytics Cloud must have the Read permission on the Joule privilege. If you create custom roles, ensure you set the permission for this privilege.

  <br>
<p align="center"> 
<img src="images/3.9.1.png"> 
</p>
<br>
<p align="center" <b>Image 5a</b></p>

  <br>
<p align="center"> 
<img src="images/3.9.2.png"> 
</p>
<br>
<p align="center" <b>Image 5b</b></p>

Role definitions with these permissions then in SAP Analytics Cloud need to be made available in SAP Build Work Zone by synching them as CDM content. Team definitions are also synched. 

<b>Tip : System Owner user cannot use analytical capabilities in Joule.They may need to create another user account and role in order to use the Analytical Insights </b>


Once the above steps are verified, follow the detailed steps to complete the configuration. 

<b>3.1	Create an OAuth Client for the Design Time in SAP SAP Analytic Cloud</b>
...
With this, you should be able to see the Configured Client  “dt” which we created manually.
  <br>
<p align="center"> 
...
<b>3.1.1	Create an OAuth Client for the Run Time in SAP Analytic Cloud</b>
...
<br>
<p align="center" <b>Image 9b</b></p>

For the next step, we will need the Token URL value from the OAuth Clients, please ensure to save this value.

After creating the design and runtime OAuth clients, you should now have two OAuth clients:
...
Under Destination Details, replace the following property values with the details from your runtime OAuth client created in SAP Analytics Cloud.

Refer to above <b>Image 9b</b> for more details on OAuth Client and Secret.
  <br>
<p align="center"> 
...
Under SAML Properties, set the following property values:
  <br>
<p align="center"> 
<img src="images/3.7.2.png"> 
</p>
<br>
<p align="center" <b>Image 13</b></p>

Under Additional Properties, use the New Property button to add the following additional properties:
  <br>
<p align="center"> 
...
<b>Tip:</b> To create <b>NavigationService</b> Destination <li>Go to <a href="https://discovery-center.cloud.sap/missiondetail/4538/4826/">Establish a Unified Joule Instance Mission</a></li> 
...
<h1 style ="font-size:4;"<b>4.	Sync Users from SAP SAP Analytic Cloud to SAP Build Work Zone using IPS</b></h1>

In the following steps, we are going to sync users from SAP SAP Analytic Cloud to SAP Build Work Zone. We will be working on SAP Cloud Identity Services, and you will need access as an Administrator. 

<b>4.1	Setup SAP SAP Analytic Cloud as a Source System</b>
...
Once the Job is triggered, you can click on <b>Identity Provisioning</b> and <b>Provisioning Logs</b> to see the status sync in progress. Important to look at the Job process with a user and a group for both the source and target system as shown in the screenshot. 
...
Additionally, you can go to <b>Settings -> Identity Provisioning</b>, enter a user <b>email address</b>, and click on <b>View Assigned Roles.</b>
  <br>
<p align="center"> 
