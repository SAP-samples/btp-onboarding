...
Under Destination Details, replace the following property values with the details from your runtime OAuth client created in SAP Analytics Cloud.Refer Image ?? for more details.
  <br>
<p align="center"> 
