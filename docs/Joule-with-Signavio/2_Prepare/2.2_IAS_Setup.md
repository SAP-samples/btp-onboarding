## 2.2. SAP Signavio with SAP Cloud Identity Services
...
### 2.2.1 Download the Metadata file from SAP Cloud Identity Services
...
### 2.2.2 Establish Trust and Download the Metadata file from SAP Signavio
...
### 2.2.3 Create an Application for Signavio in SAP Cloud Identity Services
...
### 2.2.4 Test your SAP Signavio SSO with SAP Cloud Identity Services
...
### 2.2.5 SAP Cloud Identity Services Additional Configurations
...
![Image 2.15](./images/2.15.png)

Once the group is created, you can add the users as required.

![Image 2.16](./images/2.16.png)


Ensure to repeat these steps for the entire group and confirm the required authorization.
