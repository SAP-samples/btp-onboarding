...
1. First, in your BTP Subaccount, navigate to the Overview section and look for the **Subaccount ID**. Please make a note of it.
...
4. Select the Principal Type **X.509 Certificate**, and click on Next.</br>
...
## Adding the Resource Path to HTTPS Protocol System Mapping
