...
7. In the **Transformations** tab:
   ...
   - Paste the standard transformation JSON ([Download JSON configuration](./sourcetransformation.json)).
...
6. In the **Transformations** tab:
   - Click **Edit**.
   - Switch to **JSON mode** using the `{..}` button.
   - Paste the standard transformation JSON ([Download JSON configuration](./targettransformation.json)).
