# SAP BTP Use Cases and Services 

SAP Business Technology Platform (SAP BTP) is an offering that integrates the following technology portfolios: application development, process automation, integration, data, analytics, enterprise planning, and artificial intelligence. The platform enables users to transform data into business value, compose end-to-end business processes, integrate entire IT landscapes, and personalize, build, and extend SAP applications. 
...
You can explore the SAP BTP use cases on the [SAP BTP Use Cases](https://www.sap.com/products/technology-platform/use-cases.html?sort=latest_desc).

You can explore a specific use case, for example, [Expedite your financial close with intelligent automation](https://www.sap.com/products/technology-platform/use-cases/financial-close-automation.html)

If you want further information on how to implement this use case, click on the button [Get started in the SAP Discovery Center](https://discovery-center.cloud.sap/missiondetail/3260/).
...
SAP BTP capabilities are delivered as services. Before using a service, familiarize yourself with the available service plans to select the right plan for your specific scenario. 
...
- Service Plans for the commercial model, and whether free-tier service plans are available or not.
- Regions (data center locations) and providers where you can provision them.
- The metric by which the consumption of the service is measured.
...
The prices apply to every service activated in your global account/subaccounts.

You can access the Cost Estimator using the small calculator icon in the top-level bar of the SAP Discovery Center.
