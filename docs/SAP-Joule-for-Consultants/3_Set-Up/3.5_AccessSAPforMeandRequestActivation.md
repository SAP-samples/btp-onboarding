...
<li>Admin – Complete access to all console features (settings ssetion and usage metrics section).</li>
...
<li>Search for and select <b>SAP_JOULE_CONSULTANTS – Admin</b>.</li>
...
Joule for Consultants provides access to exclusive content unavailable to other chatbots. To access this gated content, each user must have a corresponding S-user. Ensure the email address used for login matches the email associated with the S-user.
