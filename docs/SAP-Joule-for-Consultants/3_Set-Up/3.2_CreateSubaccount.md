...
We are now going to create a new SAP BTP subaccount dedicated to SAP Joule for Consultants. Remember that it is only supported in EU10, EU11, US10 ans AP10 in the current release.
