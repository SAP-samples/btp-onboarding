...
- On the **Set Up Integrations** step, a formation is created to link the systems. Keep or adjust the **Formation Name**, and in the **Include Systems** section select your **SAP Consulting Capability** system from the dropdown field. Click **Next**.

<p align="center">
  <img src="images/booster-integrations-setup.png" width="80%">
</p>
