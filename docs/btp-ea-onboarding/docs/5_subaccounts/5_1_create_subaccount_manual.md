...
1. Navigate to "Account Explorer". Click the "Create" drop-down button, then select "Subaccount."
    ...
    <img src="images_sub/5_1_1_man_create_suba_1.png" alt="Create Subaccount" width="600" />
...
5. Select "Create". The Subaccount will be created. Enter your Subaccount.
    ...
    <img src="images_sub/5_1_2_man_suba_create_2.png" alt="Create Subaccount" width="500" />
...
2. You should be added as the first Subaccount User with the Default Identity Provider.
    ...
    <img src="images_sub/5_1_3_man_user.png" alt="Subaccount user list" width="600" />

3. Click on it. You should have assigned the Subaccount Administrator role collection.

    <img src="images_sub/5_1_4_man_user_rc.png" alt="Subaccount user role collection" width="600" />
...
- You have a free Cloud Foundry quota assigned to your subaccount.
    ...
    <img src="images_sub/5_1_5_man_free_cf_quota.png" alt="free Cloud Foundry Quota" width="600" />
...
2. Select **Cloud Foundry Environment** in the tab navigation.
   ...
   Check the "Enable Cloud Foundry" button.
    ...
    <img src="images_sub/5_1_6_man_enable_cf.png" alt="Enable Cloud Foundry" width="600" />
...
3. A form opens. Keep the preconfigured values or change the following entries: 
    ...
    <img src="images_sub/5_1_7_man_cloudfoundry.png" alt="Fill out Cloud Foundry form" width="600" />
...
8. Click on "Create Space".
    ...
    <img src="images_sub/5_1_8_man_create_space.png" alt="Create Cloud Foundry Space" width="600" />

9. Provide a Space Name. Typically, choose "dev" or "test".

    Assign yourself as Space Developer and Space Manager.

    <img src="images_sub/5_1_9_man_create_space_2.png" alt="Create Cloud Foundry Space" width="600" />
...
### Subscribe to SAP Build Work Zone Service
