...
1. In the Create dropdown, choose Directory.
   ...
   <img src="images_dir/4_1_1_createdirectory.png" alt="Create a new Directory in BTP Global Account" width="800" />
...
2. In the Create Directory dialog box, enter a display name for your new directory, for example `my_first_directory`.  
   ...
   <img src="images_dir/4_1_2_createdirectory.png" alt="Create a new Directory in BTP Global Account" width="400" />
...
1. in the `...` Action menu of your Subaccount, click "Move".
   ...
   <img src="images_dir/4_1_5_move_sub.png" alt="Add a subbacount to a directory" width="800" />

2. Select your directory.

   <img src="images_dir/4_1_6_movesub2.png" alt="Add a subbacount to a directory" width="400" />

3. Select your Subaccount and select your new parent - your directory.

   Click "Move".

   <img src="images_dir/4_1_7_movesub3.png" alt="Add a subbacount to a directory" width="400" />

4. As a result, the Subaccount has now moved under the directory.

   <img src="images_dir/4_1_8_movesub4.png" alt="Add a subbacount to a directory" width="400" />
...
<img src="images_dir/4_1_11_dir_entitle.png" alt="Enable directory entitlement management" width="600">

<!--  ![Enable directory entitlement management](mages_dir/4_1_11_dir_entitle.png) -->
...
<img src="images_dir/4_1_12_assignentitlements.png" alt="Assign services to directory and subaccounts" width="800" />
