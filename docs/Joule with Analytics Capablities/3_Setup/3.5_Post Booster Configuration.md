1.	Once you have the Success message from the Joule Booster, we will need to validate the Formations that the booster has created. To validate this, you can navigate to your <b>SAP BTP Global Account</b>, click on <b>System Landscape</b> -> click on <b>Formations</b>, and look for the <b>formation ID</b> that you have created with the booster.  You should be able to see the status “<b>Ready</b>” as shown below.
...
<b>Tip: To create NavigationService Destination, please refer <a href="https://discovery-center.cloud.sap/protected/index.html#/mymissiondetail/146628/?tab=projectboard"> Establish a Unified Joule Instance > Post Booster Configuration > Create NavigationService Destination</b>
