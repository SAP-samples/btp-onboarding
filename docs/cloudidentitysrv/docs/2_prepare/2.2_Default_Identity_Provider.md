...
As you gain access to your SAP BTP Global Account, you will have users (both platform and business users) who will require access and need user management, commonly referred to as **Identity Access Management (IAM)**. 

SAP BTP offers a service called **SAP BTP Default Identity Provider** to manage the Authentication and Authorization of users.  
...
- Customer Number, generally known as Customer ID, is required while contacting SAP for support   
- Current BTP license purchase information  
...
- General information about the Support User and how to reach SAP in case of login issues 
